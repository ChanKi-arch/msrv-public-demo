...
This repository is a **public, reproducible release of the MSR-V governance engine**.

It includes:
- The actual routing and governance logic
...
are generated by the real engine logic contained in this repository.**
